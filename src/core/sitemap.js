...
export const INSERT_NOTE = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Notes/insert`;
export const UPDATE_NOTE = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Notes/update-note`;
export const ARCHIVE_NOTE = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Notes/archive-note`;
...
export const FETCH_JEWELLERY_BILLING_AUTO_SUGGESTIONS = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Stocks/fetch-billing-auto-suggestions`;
...
export const GET_FUND_TRNS_LIST_CONSOLIDATED = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/FundTransactions/fetch-consol-transactions`;
...
export const CLOSE_UDHAAR = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Udhaars/close-udhaar`;
export const REOPEN_UDHAAR = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Udhaars/reopen-udhaar`;
export const FETCH_UDHAAR_LIST = `${config.proxy_protocol}://${config.proxy_api_host}:${config.proxy_api_port}/${config.restApiRoot}/Udhaars/get-udhaar-bills`;
