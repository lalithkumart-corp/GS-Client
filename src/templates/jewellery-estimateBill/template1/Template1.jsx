...
function EstimateBillTemplate1(props) {
    ...
    return (
        <div className={`jewellery-estimate-bill-paper template1 ${printContent?'has-printcontent':''}`}>
...
export default EstimateBillTemplate1;
